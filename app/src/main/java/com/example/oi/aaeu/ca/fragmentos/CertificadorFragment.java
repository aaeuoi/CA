...
public class CertificadorFragment extends Fragment {
...
//        private int imagen;
    ...
    public static CertificadorFragment newInstance(String area, String cat, String subc, String sku,
//        public static FragmentosImagenes newInstance(int imagen, String nombre, String formato
        ...
        CertificadorFragment fragment = new CertificadorFragment();
...
//        id_drawable = args.getInt("N_FOTO");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            rootView = (View) inflater.inflate(R.layout.fragment_certificador, container, false);
