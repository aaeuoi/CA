...
//        private int imagen;
    ...
    public static DestacadosFragment newInstance(String area, String cat, String subc, String sku,
//        public static FragmentosImagenes newInstance(int imagen, String nombre, String formato
        ...
        DestacadosFragment fragment = new DestacadosFragment();
...
//        id_drawable = args.getInt("N_FOTO");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            rootView = (View) inflater.inflate(R.layout.fragment_destacados, container, false);
