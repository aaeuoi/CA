...
//        private int imagen;
    ...
    public static ConsultoriaFragment newInstance(String area, String cat, String subc, String sku,
//        public static FragmentosImagenes newInstance(int imagen, String nombre, String formato
        ...
        ConsultoriaFragment fragment = new ConsultoriaFragment();
...
//        id_drawable = args.getInt("N_FOTO");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            rootView = (View) inflater.inflate(R.layout.fragment_consultoria, container, false);
